...
# tensorflow 提供的工具，将数据填充为最大长度，默认0填充
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        # 卷积池化网络导入
        cnn = TextCNN(
            sequence_length=x_train.shape[1],  # 每个句子的单词数, 即：max_document_length
        ...
        grads_and_vars = optimizer.compute_gradients(cnn.loss)  # 损失函数对应的梯度变量
